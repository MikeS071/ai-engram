...
Thoroughly analyze the user's reference material to identify:
...
Create 5 distinct post concepts based on this analysis, following this development process for each:

1. Choose a counterintuitive truth from the reference material
2. Frame it as an absolute principle
3. Come up with short and practical examples
...
- **Core Problems:** 2-3 short, tangible, and relatable pain points in the archetype's personal life
...
Apply these specific language techniques:
...
Extract components that follow engagement patterns:
...
Generate all 5 outlines at once, making each distinct while maintaining high quality.

If the reference material lacks sufficient content for engaging outlines, note this and extract what's possible.
